...
savename1 = 'PSLR_methylComps_traitComps_Turk_Neiman.png';
savename2 = 'PSLR_methylComps_traits_Turk_Neiman.png';
savename3 = 'PSLR_traits_predictedTraits_Turk_Neiman.png';

% savename1 = 'Proteome_PSLR_predict_vs_actual_traits.png';
% savename2 = 'Proteome_PSLR_covariance.png';
% exportName = 'Proteome_PSLR_predict_vs_actual_stats.xls';
% savename3 = 'MainComps2traits.png';
% savename4 = 'PSLR_Pvalues_Turk.png';
rescale = 0;
% _Rescaled
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
