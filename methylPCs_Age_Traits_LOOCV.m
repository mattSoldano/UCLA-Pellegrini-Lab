...
clear; clc; close;
%% Export names
exportName = 'PC_Age_predictTraits++_LOOCV.xlsx';
...
for j = 1:width(Vblnames)
    ...
    allData = [ALLmae, ALLrSq, log10(ALLagePval), log10(ALLpcPval)];
    ...
    writecell({'PC log 10 P Values'}, exportName, 'Sheet', j, 'Range', 'E2')
